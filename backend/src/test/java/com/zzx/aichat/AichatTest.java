package com.zzx.aichat;

import com.zzx.aichat.service.AiManage;
...
//        final ChatMessage systemMessage = ChatMessage.builder().role(ChatMessageRole.SYSTEM).content("你是一个java编程专家").build();
...
//                .botId("bot-20251128101905-swd4d")
//                .messages(messages)
//                .build();
//
